...
extension String {
    ...
    func localized(replace: String? = nil) -> String {
        if let replaceString = replace {
            return NSLocalizedString(self, comment: "").replacingOccurrences(of: "%s", with: replaceString)
        } else {
